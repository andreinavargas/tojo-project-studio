  ...
  return (
    <button
      ...
      className={
        desktop
          ? dopamineMode
            ? 'inline-flex items-center gap-3 rounded-full px-6 py-3 text-sm font-bold uppercase tracking-[0.08em] text-white transition hover:bg-white/10'
          ...
          : dopamineMode
            ? 'fixed bottom-5 left-1/2 z-[9999] inline-flex -translate-x-1/2 items-center gap-3 rounded-full border border-[#111111] bg-[#111111] px-5 py-3 text-xs font-bold uppercase tracking-[0.08em] text-white shadow-[0_16px_40px_rgba(17,17,17,0.25)] md:hidden'
    ...
    >
      <span
        className={
          dopamineMode
            ? 'h-3 w-3 rounded-full bg-[#F4362F]'
            : 'h-3 w-3 rounded-full bg-[#6F87A3]'
        }
      />
