import DopaminePoster from './DopaminePoster';
export default function Hero({ dopamineMode }) {
  if (dopamineMode) return <DopamineHero />;
      ...
      <div className="mx-auto grid min-h-[760px] max-w-[1680px] items-center gap-16 px-8 pb-20 pt-40 lg:grid-cols-[0.9fr_1.1fr] lg:px-16">
        <div className="max-w-[580px]">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            <a href="#contact" className="inline-flex justify-center rounded-lg border border-zinc-950 bg-zinc-950 px-9 py-4 text-sm font-semibold uppercase tracking-[0.08em] text-white">
              Let&apos;s talk
            </a>

            <a href="#services" className="inline-flex justify-center rounded-lg border border-zinc-500 bg-white/70 px-9 py-4 text-sm font-semibold uppercase tracking-[0.08em] text-zinc-950">
              Services
            </a>
          </div>
        </div>
...
function DopamineHero() {
  return (
    <section className="bg-[#FFF3D6]">
      <div className="mx-auto grid min-h-[760px] max-w-[1680px] items-center gap-12 px-8 pb-8 pt-40 lg:grid-cols-[0.78fr_1.22fr] lg:px-16">
        <div>
          <p className="mb-8 text-[11px] font-bold uppercase tracking-[0.22em] text-[#111111]">
            Frontend systems · Software architecture · Digital interfaces
          </p>

          <h1 className="max-w-[640px] text-[58px] font-black uppercase leading-[0.92] tracking-[-0.055em] text-[#111111] md:text-[82px] lg:text-[94px]">
            Digital
            <br />
            systems,
            <br />
          ...
          <div className="mt-5 h-[5px] w-20 bg-[#F4362F]" />

          <p className="mt-7 max-w-[500px] text-[17px] font-semibold leading-8 text-[#111111]">
            Software architecture, frontend development and content strategy for
            products that are clear, scalable and well built.
          </p>

          <div className="mt-9 flex flex-col gap-4 sm:flex-row">
            <a href="#contact" className="inline-flex justify-center border-2 border-[#111111] bg-[#F4362F] px-9 py-4 text-sm font-black uppercase tracking-[0.08em] text-white shadow-[4px_4px_0_#111111]">
              Let&apos;s talk
            </a>

            <a href="#services" className="inline-flex justify-center border-2 border-[#111111] bg-[#FFF3D6] px-9 py-4 text-sm font-black uppercase tracking-[0.08em] text-[#111111] shadow-[4px_4px_0_#111111]">
              Our services
            </a>
          </div>
        </div>
